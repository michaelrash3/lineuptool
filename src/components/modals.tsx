        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p className="text-[11px] text-ink-3 font-medium mb-3">
                ...
                catcher — <strong className="text-ink">C is opt-in</strong>, so
                a player is only ever seated at catcher when you select it here.
              </p>
            ...
            <div className="p-5 bg-surface border border-line rounded-xl shadow-sm">
              ...
              <p className="text-[11px] text-ink-3 font-medium mb-3 leading-snug">
                Use <strong className="text-ink">Departed</strong> when a player
                is no longer with the team before the season ends. They stay in
                history and reports, but stop appearing in game-day attendance.
              </p>
              <select
          ...
          >
            ...
            <div className="bg-surface border border-line rounded-xl p-5 shadow-sm">
              ...
              {(player.pastSeasons || []).length === 0 && !addingPastSeason ? (
