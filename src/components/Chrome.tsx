          ...
          createPortal(
            ...
            <div className="fixed inset-0 z-[60] print:hidden">
              ...
              <nav
                ...
                className="nav-drawer-panel absolute inset-y-0 left-0 w-[300px] max-w-[88vw] flex flex-col bg-surface border-r border-line shadow-2xl"
              ...
              >
                ...
                <div className="border-t border-line px-3 py-3 flex flex-col gap-2 bg-surface-2">
                  <NavRow
                    icon={Icons.Help}
